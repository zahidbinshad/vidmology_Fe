    ...
    >
      <Container>
        ...
        <div className="text-center" style={{ marginBottom: "32px" }}>
          ...
          <p style={{ fontSize: "18px", fontWeight: 400, lineHeight: "140%", color: "#878787", whiteSpace: "pre-line", margin: 0 }}>
            {levelUpCta.subtitle}
          </p>
        </div>
  ...
  return (
    ...
    >
      <div style={{ width: 36, height: 36, background: "rgba(29,190,91,0.1)", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        ...
        <img src="/comment-02.svg" alt="" width={20} height={20} aria-hidden />
      </div>
      {label}
    </div>
  );
