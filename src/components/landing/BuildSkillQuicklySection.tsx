        ...
        <Row className="g-4">
          {builtDifferentlyCards.map((card, index) => {
            ...
            <Col md={4} key={card.title}>
              <div className="card-lift" style={{ background: "#fff", border: "1px solid #f0f0f0", borderRadius: "20px", padding: "32px", height: "100%", display: "flex", flexDirection: "column", gap: "24px", boxShadow: "4px 4px 14px rgba(0,0,0,0.06)" }}>
                {/* Icon */}
                <div className="icon-badge" style={{ width: 56, height: 56, background: "rgba(29,190,91,0.08)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  ...
                  {card.bodyParagraphs.map((p, i) => (
                    <p key={i} style={{ margin: 0, fontSize: "16px", fontWeight: 400, lineHeight: "140%", color: "#878787" }}>
                      {p}
                    </p>
                  ))}
